...
que = {}
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "2022313646").split()))
API_ID = int(getenv("API_ID", "1973181"))
API_HASH = getenv("API_HASH", "f2424789557a9519f5949d95b85b3985")
LOG_GROUP = getenv("LOG_GROUP", "-1001594138250")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "")
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "")
SPOTIFY_USERNAME = getenv("SPOTIFY_USERNAME", "")
MONGO_DB = getenv("MONGO_DB", "mongodb+srv://userbot:<password>@cluster0.ws8j2.mongodb.net/?retryWrites=true&w=majority")
ALIVE_IMG = getenv("ALIVE_IMG", "")
DB_URL = getenv("DATABASE_URL", "mongodb+srv://userbot:userbot@cluster0.ws8j2.mongodb.net/ubot?retryWrites=true&w=majority")
STRING_SESSION1 = getenv("STRING_SESSION1", "1BVtsOIUBu19ozj4xkBKdvxFPoRl0s4w0oSPNDPGsTy--OIPylXMJ1LNHZtxNSC6rFMUMv_WeJplC-sjBYkNj86wg9t7g644AgoTPaw10cQRoXxQjstAG5RH0l9K95tTzJoO1FEuDIejiLxGCkRIAjDG0befC7lSBMQFZPuNIfjsQz4WX3EM6Jdw3WCJ3Qpl5coWCPVIRGDr7Quu5aSNUPToRTbgMvj4usxpRZoojFMOO10T8LvwD-unoI7jeoW_CzKshJ608YT1nmQ9vp-G5skjvtVVbaWZ7sAPnvrDVfIS3A9UAuMsW1R64tUpl438qOM0RFmvBk6YG8DOQoWoQ75qNRDmNrCY=")
